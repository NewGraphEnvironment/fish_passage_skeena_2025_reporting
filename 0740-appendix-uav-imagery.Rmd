...
# Driven from the param, not hardcoded. A literal here shadows params$project_region
# and, because this chunk is eval = F, the table it writes to sqlite outlives the
# repo it was written in — that is how the Fraser 2025 report came to publish Peace
# imagery. See NewGraphEnvironment/fish_passage_fraser_2025_reporting#19.
project_uav <- tab_uav |>
