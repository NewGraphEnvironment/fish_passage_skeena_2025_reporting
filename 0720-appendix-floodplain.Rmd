...
```{r flood-map-detail, fig.cap = "Detail view of the Bulkley River valley immediately north of Smithers. Symbology as Figure \\@ref(fig:flood-map-wsg); named streams labelled in italic blue; municipalities outlined and labelled in red."}
