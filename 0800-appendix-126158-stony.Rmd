...
?? Comments say "Bull trout documented downstream of the crossing in 2014." but can't find any evidence of this in modelling. 
...
tab_edna |> 
  ...
  dplyr::select(-site) |> 
  fpr_kable(caption_text = my_caption)
