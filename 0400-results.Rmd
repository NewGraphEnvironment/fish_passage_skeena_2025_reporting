...
```{r hab-conf-rollup, include = FALSE}
# Derive the scope of the habitat confirmation work from the confirmation data
# itself rather than from params$wsg_code. Confirmations were completed in a
# subset of the project's watershed groups, so naming all of them overstates the
