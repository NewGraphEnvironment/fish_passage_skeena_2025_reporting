...
PSCIS crossing `r as.character(my_site_mon)` on Waterfall Creek is located on 11th Avenue within the Kispiox River watershed group. The culvert at this crossing has been removed by the Gitksan Watershed Authorities, and the site was visited in `r params$project_year` under the effectiveness monitoring program.
