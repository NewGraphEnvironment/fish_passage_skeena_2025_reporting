...
path_form_pscis_raw <- fs::path_expand(fs::path('~/Projects/gis/', params$gis_project_name ,'/data_field/', params$project_year, '/form_pscis_2024_raw.gpkg'))

# path to NEW geopackage which is cleaned and contains added columns as per this script
path_form_pscis <- fs::path_expand(fs::path('~/Projects/gis/', params$gis_project_name ,'/data_field/', params$project_year, 'form_pscis_2024.gpkg'))
```
