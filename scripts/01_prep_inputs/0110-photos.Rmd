...
fs::dir_copy(fs::path(dir_photos_originals,"ai/originals"),
             "/Users/airvine/Projects/current/2024-073-sern-peace-fish-passage/data/photos/ai")

fs::dir_copy(fs::path(dir_photos_originals,"ls/originals"),
             "/Users/airvine/Projects/current/2024-073-sern-peace-fish-passage/data/photos/ls")

# remove the originals from onedrive
fs::dir_delete(fs::path(dir_photos_originals,"ai/originals"))
fs::dir_delete(fs::path(dir_photos_originals,"ls/originals"))
