...
```{r create-site-dir-pscis}

form_raw <- fs::path_expand(fs::path("~/Projects/gis/", params$gis_project_name, 'form_pscis.gpkg'))
form_new <- fs::path_expand(fs::path("~/Projects/gis/", params$gis_project_name, 'data_field/2025/form_pscis_2025.gpkg'))
...
form_new <- fs::path_expand(fs::path("~/Projects/gis/", params$gis_project_name, 'data_field/2025/form_fiss_site_2025.gpkg'))
