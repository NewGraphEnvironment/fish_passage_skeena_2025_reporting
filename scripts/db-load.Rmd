...
t <- sites_p2 |> 
  dplyr::select(1:4, stream_name, road_name, assess_type_phase1, assess_type_phase2, assess_type_reassessment, assessment_comment, fish_sampling, source_repo, source_gis)
