...
A sortable table with user input is demonstrated at https://github.com/NewGraphEnvironment/restoration_wedzin_kwa_2024_recomendations.  If we move to quarto (want to but haven't figured out how to password protect online reports yet) we should be able to include in the body of the same reports......
