...
date: |
 |
 | Version 0.3.0 DRAFT `r format(Sys.Date(), "%Y-%m-%d")`
 |
 | *Claude Opus 4.7 (Anthropic) assisted with literature synthesis, drafting, and technical writing. All scientific interpretation, data analysis, and conclusions are the responsibility of the authors.*
...
params:
  ...
  pscis_funding_project_number: "fraser_2025_phase1"
nocite: |
...
This work takes place within the territories of First Nations who have stewarded these lands and waters since time immemorial.
